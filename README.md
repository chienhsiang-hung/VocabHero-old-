...
If you'd like to create a next.js app directly in the current folder:
```bash
npx create-next-app@latest ./ --example "https://github.com/steven-tey/precedent"
```
...
pnpm i
```
If you got resolving error, use `yarn install`. The solution is to use Yarn instead of Npm.
